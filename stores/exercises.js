...
import basicPastSimpleMultipleChoice from '~/data/basic/past-simple/multiple-choice.yml'
import basicPastSimpleErrorIdentification from '~/data/basic/past-simple/error-identification.yml'
import basicPastSimpleFillInTheBlanks from '~/data/basic/past-simple/fill-in-the-blanks.yml'
import basicPastSimpleMatching from '~/data/basic/past-simple/matching.yml'
import basicPastSimpleSentenceCompletion from '~/data/basic/past-simple/sentence-completion.yml'
import basicPastSimpleTrueOrFalse from '~/data/basic/past-simple/true-or-false.yml'
	...
	state: () => ({
		...
		difficulties: {
			basic: {
				...
				topics: {
					'greetings-and-introductions': {
						...
						exercises: {
							...
							'fill-in-the-blanks': {
								...
								items:
									basicGreetingAndIntroductionsFillInTheBlanks?.items || [],
							},
							matching: {
							...
							'error-identification': {
								...
								items:
									basicGreetingAndIntroductionsErrorIdentification?.items || [],
							},
							'sentence-completion': {
								...
								items:
									basicGreetingAndIntroductionsSentenceCompletion?.items || [],
							},
							'true-or-false': {
					...
					'personal-pronouns': {
						...
						explanation:
							"Personal pronouns in English are essential for clear communication. Unlike Spanish, English pronouns must always be explicitly stated in sentences. They change form depending on their function in the sentence (subject vs object pronouns) and there's no gender for objects ('it' for all non-living things).",
						details: [
					...
					'daily-routines': {
						...
						explanation:
							'Daily routines in English are expressed using the simple present tense and often include specific time expressions. The key is understanding how to structure sentences about habitual actions and the importance of time markers.',
						details: [
					...
					'prepositions-of-time': {
						...
						explanation:
							'Prepositions of time in English are used to indicate when something happens. They are essential for constructing sentences about daily routines, schedules, and events.',
						details: [
					...
					'simple-present': {
						...
						explanation:
							"The simple present tense in English is used to express habits, general truths, and scheduled events. Unlike Spanish, it has a specific form for third person singular and doesn't change based on formality level.",
						details: [
					...
					negatives: {
						label: 'Negativos',
						explanation:
							'English negatives follow a strict structure using auxiliary verbs (do/does/did) + not. Unlike Spanish, double negatives are not allowed, and the main verb always remains in its base form in negative sentences.',
						details: [
					...
					'present-continuous': {
						...
						explanation:
							"Present continuous (also called present progressive) expresses actions happening right now or temporary actions. It's formed with the verb 'to be' (am/is/are) + verb-ing. This tense is often confused by Spanish speakers who tend to use simple present for current actions.",
						details: [
					...
					'time-differentiation': {
						...
						explanation:
							'Time differentiation in English requires understanding when to use simple present versus present continuous, and how different time expressions signal different tenses. This distinction is crucial as it affects verb forms and sentence structure.',
						details: [
						...
						examples: [
							{
								english:
									'I work at a bank (routine) / I am working right now (current)',
							...
							},
							{
								...
								spanish:
									'Ella usualmente cocina la cena / Ella está cocinando la cena ahora',
								pronunciation:
									'shi yusuali kuks diner / shi is kuking diner nau',
								note: 'Time words signal which tense to use',
							},
							{
								english:
									'They live in Paris (permanent) / They are living in Paris (temporary)',
					...
					'indicating-words': {
						...
						explanation:
							"Indicating words in English (determiners, demonstratives, and time markers) help specify which things we're talking about and when events occur. These words are essential for clear communication and proper time reference.",
						details: [
					...
					'past-simple': {
						...
						exercises: {
							'multiple-choice': {
								...
								isActive: true,
								component: 'MultipleChoice',
								items: basicPastSimpleMultipleChoice?.items || [],
							},
							'fill-in-the-blanks': {
								label: 'Rellena los Espacios',
								order: 2,
								isActive: true,
								component: 'FillInTheBlanks',
								items: basicPastSimpleFillInTheBlanks?.items || [],
							},
							matching: {
								label: 'Emparejamiento',
								order: 3,
								isActive: true,
								component: 'Matching',
								items: basicPastSimpleMatching?.items || [],
							},
							'error-identification': {
								label: 'Identificación de Errores',
								order: 4,
								isActive: true,
								component: 'ErrorIdentification',
								items: basicPastSimpleErrorIdentification?.items || [],
							},
							'sentence-completion': {
								label: 'Completar Oraciones',
								order: 5,
								isActive: true,
								component: 'SentenceCompletion',
								items: basicPastSimpleSentenceCompletion?.items || [],
							},
							'true-or-false': {
								label: 'Verdadero o Falso',
								order: 6,
								isActive: true,
								component: 'TrueOrFalse',
								items: basicPastSimpleTrueOrFalse?.items || [],
							},
						},
						order: 90,
						isActive: true,
					...
					'question-formation': {
						...
						explanation:
							'Questions in English follow specific word order patterns and require auxiliary verbs. Unlike Spanish, English questions must use auxiliaries (do/does/did) or change word order with be/have. The structure varies between yes/no questions and information (wh-) questions.',
						details: [
					...
					'time-expressions': {
						...
						explanation:
							'Time expressions in English help specify when actions occur and are crucial for using the correct tense. They often differ from Spanish in structure and placement within sentences. Understanding these expressions is key for accurate temporal communication.',
						details: [
					...
					'short-answers': {
						...
						explanation:
							'Short answers in English are essential for natural conversation. Unlike Spanish, where a single word might suffice, English requires a pronoun and auxiliary verb in short answers. This structure maintains grammatical completeness while being concise.',
						details: [
					...
					'frequency-adverbs': {
						...
						explanation:
							'Frequency adverbs in English indicate how often actions occur. Unlike Spanish, these adverbs have a specific position in the sentence - usually before the main verb but after auxiliary verbs. They are essential for discussing habits and routines.',
						details: [
			...
			intermediate: {
				label: 'Intermedio',
				explanation:
					'En esta otra sección un poco más avanzados que los básicos.',
				order: 2,
				isActive: false,
			},
			advanced: {
				label: 'Avanzado',
				explanation:
					'En esta sección encontrarás ejercicios para practicar los conceptos avanzados.',
				order: 3,
				isActive: false,
			},
		},
